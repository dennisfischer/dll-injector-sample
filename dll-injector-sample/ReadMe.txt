========================================================================
    DYNAMIC LINK LIBRARY: dll-injector-sample-Projektübersicht
========================================================================

Diese dll-injector-sample-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre dll-injector-sample-Anwendung besteht.


dll-injector-sample.vcxproj
...
dll-injector-sample.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen dll-injector-sample.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
